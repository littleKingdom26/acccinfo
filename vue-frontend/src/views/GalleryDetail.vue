<template>
    <div class="home">
        ...
        <div
            v-if="mainFilePath"
            class="session notice content Staatliches mb-5 text-center"
        >
            <img :src="mainFilePath" />
        </div>
        <div v-else class="session notice Staatliches text-center mb-5">
            <div class="row header">
                <div class="count">이미지가 없습니다...</div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        _getContent() {
            this.$axios
                .get(`/api/gallery/detail/${this.bbsSeq}`, {
                ...
                .then((data) => {
                    ...
                    this.mainFilePath = data.data.data.mainFilePath;
                });
        },
